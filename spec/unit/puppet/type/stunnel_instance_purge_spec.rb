...
describe Puppet::Type.type(:stunnel_instance_purge) do
  ...
  it 'does not accept non-absolute paths for any :dirs entries' do
    expect {
      Puppet::Type.type(:stunnel_instance_purge).new(
        name: 'test',
        dirs: [
