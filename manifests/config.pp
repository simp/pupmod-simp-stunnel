...
class stunnel::config (
  ...
  Variant[Boolean,Enum['zlib','rle']]        $compression    = false,
  Variant[Boolean, String]                   $egd            = false,
  String                                     $engine         = 'auto',
  Variant[Boolean, String]                   $engine_ctrl    = false,
  Variant[Boolean, Stdlib::Absolutepath]     $output         = false,
  Variant[Boolean, Stdlib::Compat::Integer]  $rnd_bytes      = false,
  Variant[Boolean, Stdlib::Absolutepath]     $rnd_file       = false,
